...
for ($i = 1; $i <= $numberofslides; $i++) {
    ...
    $title = get_string('slideStatus', 'theme_academi', array('slide' => $i));
    $description = get_string('slideStatus_desc', 'theme_academi', array('slide' => $i));
    $default = YES;
    $choices = [
    ...
    $title = get_string('slidecontentstatus', 'theme_academi', array('slide' => $i));
    $description = get_string('slidecontentstatus_desc', 'theme_academi', array('slide' => $i));
    $default = YES;
    ...
    $description = get_string('slidebtntarget_desc', 'theme_academi', array('slide' => $i));
    $default = NEWWINDOW;
    $choices = [
    ...
    $title = get_string('slidecontent', 'theme_academi', array('slide' => $i));
