...
class __Mustache_89d8abb3c3d5343e9fb53ccc1d84af1f extends Mustache_Template
{
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block30d9c5998a479f0c769f373a70b9940d'),
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block59fe17ce13d2e244949d6e84f6885c88'),
...
';
    ...
    public function block30d9c5998a479f0c769f373a70b9940d($context)
    {
        $indent = $buffer = '';
        $buffer .= '                    ';
...
';
    ...
    public function block59fe17ce13d2e244949d6e84f6885c88($context)
    {
        $indent = $buffer = '';
